...
const AdresModal = ({ isActive, setIsActive }: Props) => {
  ...
  return (
    <div className="fixed inset-0  bg-black bg-opacity-40 flex justify-center items-center ">
      {!isOn ? (
        <div className="w-[600px] h-[600px] align-top bg-white rounded p-8 flex flex-col justify-center items-center">
          <div className="bg-white mb-8 w-full p-0 font-bold justify-between mt-0  flex ">
            ...
            <span onClick={handleClick} className="w-16 h-16 place-self-end rounded-full justify-center  items-center flex hover:bg-gray-100 cursor-pointer">
              <svg
...
<div className="flex flex-col w-96 mb-4">
          ...
          <div
            ...
            className="bg-white  w-96  p-5 rounded mb-4 border flex shadow-lg font-bold cursor-pointer"
          >
          ...
          <div className="bg-white p-5 mb-4 w-96 shadow-lg  border rounded flex font-bold cursor-pointer">
            <img
          ...
          <div className="bg-white p-5 w-96 rounded border shadow-lg  flex font-bold  cursor-pointer">
